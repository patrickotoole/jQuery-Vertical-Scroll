...
(function($) {
	...
	*/
		...
		if (jQuery.isFunction(jQuery.fn.mousewheel)) {
			$("#"+id).mousewheel(function(event, amount){
				...
				if (((slider_value == 0 ) && (amount > 0)) || ((slider_value == 100 ) && (amount < 0)) ||((slider_value > 0 ) && (slider_value < 100 )))
				{
					...
					// This needs to be dealt with better for cross browse scrolling
					var step = 
						parseInt(amount*$.fn.scrollbar.wheel.multiplier) == amount*$.fn.scrollbar.wheel.multiplier ? amount*$.fn.scrollbar.wheel.multiplier :
						parseInt(amount/0.025) == amount/0.025 	? $.fn.scrollbar.wheel.multiplier = 40 : 
						parseInt(amount*3) == amount*3 			? $.fn.scrollbar.wheel.multiplier = 3*5 : null;
					
					var current_direction = Math.abs(step)/step;
					
					current_direction === $.fn.scrollbar.wheel.previous_direction ?	
						$.fn.scrollbar.incrementSlider(step,id,scrollDifference) : $.fn.scrollbar.wheel.previous_direction = current_direction ;
	...
	$.fn.scrollbar.wheel.multiplier = 1;
	$.fn.scrollbar.wheel.previous_direction = 1;
